defmodule AcqdatApi.DataStructure.Trees.NaryTree.NaryTreeTest do
  use ExUnit.Case
  ...
  setup_all do
    ...
    complex_tree =
      NaryTree.new(NaryTree.Node.new("AT 4", "Root node"))
    ...
    [
      simple_tree:
        NaryTree.new(NaryTree.Node.new("AT 6", "Root node"))
