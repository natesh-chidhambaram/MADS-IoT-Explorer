defmodule AcqdatApiWeb.Reports.WidgetErrorHelper do
...
defmodule AcqdatApiWeb.Reports.WidgetTypeErrorHelper do
  def error_message(:resource_not_found) do
    %{
      title: "Invalid entity ID",
...
defmodule AcqdatApiWeb.Reports.UserWidgetErrorHelper do
  def error_message(:resource_not_found) do
    %{
      title: "Invalid entity ID",
