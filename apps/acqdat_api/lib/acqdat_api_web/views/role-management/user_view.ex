defmodule AcqdatApiWeb.RoleManagement.UserView do
  ...
  def render("user_setting.json", %{user: setting}) do
    %{
      id: setting.id,
      visual_settings: setting.visual_settings && Map.from_struct(setting.visual_settings),
      data_settings: setting.data_settings && Map.from_struct(setting.data_settings)
    }
  end
