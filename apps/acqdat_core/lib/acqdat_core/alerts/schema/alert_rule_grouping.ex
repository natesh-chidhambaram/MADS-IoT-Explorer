defmodule AcqdatCore.Alerts.Schema.AlertRulesGrouping do
  use AcqdatCore.Schema
  alias AcqdatCore.Alerts.Schema.AlertRuleTimeGrouping

  @primary_key false
  embedded_schema do
    field(:module, AlertGroupingEnum)
...
defmodule AcqdatCore.Alerts.Schema.AlertRuleTimeGrouping do
  use AcqdatCore.Schema
