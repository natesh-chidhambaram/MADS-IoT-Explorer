defmodule AcqdatCore.Schema.ToolManagement.ToolIssue do
  @moduledoc """
  Models metadata table to store tool issue information.
  """

  use AcqdatCore.Schema
  alias AcqdatCore.Schema.ToolManagement.{Employee, Tool, ToolBox}
  ...
  schema("acqdat_tm_tool_issue") do
    field(:issue_time, :utc_datetime)
