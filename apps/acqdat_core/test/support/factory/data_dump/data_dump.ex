defmodule AcqdatCore.Test.Support.DataDump do
  ...
  def setup_gateway(:list_parameter) do
    org = insert(:organisation)
    project = insert(:project, org: org)
    asset = insert(:asset, org: org, project: project)
    gateway = insert_gateway(org, project, asset)
    ...
    gateway = insert_mapped_parameters_with_list_inside_list_object(gateway, sensor1, sensor2)
    [dump_iot_data_for_nested_list(gateway), sensor1, sensor2, gateway]
  end
  ...
  def dump_iot_data_for_nested_list(gateway) do
    hour = Enum.random(0..20)
    minute = Enum.random(0..40)
    time = Timex.now() |> Timex.set(hour: hour, minute: minute)
  ...
  def insert_mapped_parameters_with_list_inside_list_object(gateway, sensor1, sensor2) do
    [param1, param2] = sensor1.sensor_type.parameters
    [param3, param4] = sensor2.sensor_type.parameters
    [param5, param6] = gateway.streaming_data
